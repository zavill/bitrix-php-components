...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
        ...
        "Menu" => array(
            "PARENT" => "BASE",
            "NAME" => "Находится ли компонент в хидэре?",
            "TYPE" => "CHECKBOX",
            "MULTIPLE" => "N",
            "DEFAULT" => "N",
        ),
        ...
        "RELOAD_TIME" => array(
          "PARENT" => "BASE",
          "NAME" => "Время до повторной отправки СМС",
          "TYPE" => "STRING",
          "DEFAULT" => "60"
        ),
        "ReCaptchaCode" => array(
        ...
        "ReCaptchaAttempts" => array(
            "PARENT" => "CAPTCHA",
            "NAME" => "Колчичество попыток для активации капчи",
            "TYPE" => "STRING",
            "MULTIPLE" => "N",
            "DEFAULT" => "",
        ),
